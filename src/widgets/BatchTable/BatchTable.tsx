...
import { deleteBatch, type Batch } from '@entities/batch/models/batchSlice';
                ...
                <tbody>
                    {batches.map((batch) => (
                        <tr key={batch.id}>
                            ...
                            <td>{batch.total_capsules}</td>

                            <td>
                                <button className="edit" onClick={() => onEdit(batch)}>
