...
import { setBatches, type Batch } from '@entities/batch/models/batchSlice';
    ...
    return (
        <div className="batchesPage">
            <div className="pageHeader">
                <div>
                    <h1>Партии</h1>
                    <p>Управление производственными партиями</p>
                </div>
            ...
            <BatchTable onEdit={setEditingBatch} />
            ...
            {editingBatch && (
                <div className="modalOverlay">
                    <div className="modal">
                        <button className="closeButton" onClick={() => setEditingBatch(null)}>
                            ×
                        </button>
